...
def apply_rule_net(input,name,reuse=tf.AUTO_REUSE):
    ...
    with tf.variable_scope(name, reuse=reuse):
        ...
        out_4 = tf.contrib.layers.fully_connected(out_2, H.state_size,activation_fn=act)
        mapped_out_4 = tf.stack([out_4]* H.seq_length, 1)
