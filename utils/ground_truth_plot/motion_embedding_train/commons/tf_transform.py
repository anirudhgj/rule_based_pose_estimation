...
a = tf.constant(sk_data.arbitary_vec, dtype=tf.float32)
D = tf.constant(sk_data.D, dtype=tf.float32)
...
def tf_local2global(dS_local):
    ...
    # print "lefthip",sk_data.joint_map['left_hip']
    # print "right_hip",sk_data.joint_map['right_hip']
