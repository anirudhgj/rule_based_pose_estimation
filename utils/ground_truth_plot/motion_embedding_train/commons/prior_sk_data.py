...
vnect_to_prior_perm = [14, 1, 2, 3, 4, 5, 6, 7, 0, 8, 9, 10, 11, 12, 13]
...
joint_names = [
	...
	'head_top',  # 9
	'right_hip', 'right_knee', 'right_ankle',  # 12
	'left_hip', 'left_knee', 'left_ankle'  # 15
]
...
torso_joints = [0, 1, 2, 5, 9, 12]

upper_limbs = {3, 6, 8, 10, 13}

neck_joints = {3, 6, 8}

child = [3, 4, 6, 7, 8, 10, 11, 13, 14]

dirname = os.path.dirname(__file__)

K = np.load('./commons/static_pose_modified.npy')

D = np.array(K)

arbitary_vec = loadmat(os.path.join(dirname, './staticPose.mat'))['a'].squeeze()
