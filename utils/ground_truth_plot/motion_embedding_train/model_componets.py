...
#     sk_batch_local = unit_norm(sk_batch_local, axis=-1)
#     return skeleton_batch, sk_batch_local, transform_mats
...
joint_names = [
    ...
    'head_8',
    'r_hip_9', 'r_knee_10', 'r_ankle_11',
    'l_hip_13', 'l_knee_14', 'l_ankle_15',
]
...
encoder_joints_dict = {
    ...
    ##
    'r_leg': ['r_hip_9', 'r_knee_10', 'r_ankle_11'],
    'l_leg': ['l_hip_13', 'l_knee_14', 'l_ankle_15'],
    ##
...
def BatchDiscriminatorNet(input_disc_z, reuse=False, use_relu=True, name="BatchDiscNet"):
    with tf.variable_scope(name, reuse=tf.AUTO_REUSE):
        ...
        op10 = tf_layer.fully_connected(op9,
                                        num_outputs=1,
                                        activation_fn=None,
                                        scope='fc9',
                                        reuse=reuse)
