...
def train():
    ...
    for iteration_no in range(0,H.max_iterations):
		...
		if iteration_no % 10 == 0:
			...
			fig_img = utils.gen_plot(fig, train_batch[:H.seq_length].reshape([H.seq_length, H.num_joints, 3]), op_train_dict['final_pose'][:H.seq_length].reshape([H.seq_length, H.num_joints, 3]), az=90)
